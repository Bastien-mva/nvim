...
vim.cmd[[autocmd FileType python nnoremap <buffer> <F8> :w \| sp \| hor resize 10 \| term uv run % <CR>]]
vim.cmd[[autocmd FileType r nnoremap <buffer> <F8> :w \| sp \| hor resize 10 \| term Rscript % <CR>]]
vim.cmd[[autocmd FileType r nnoremap <buffer> <F6> 1G0vG$<Plug>SlimeRegionSend]]
vim.cmd[[autocmd FileType r nnoremap <buffer> <F9> 0v$<Plug>SlimeRegionSend <Down>]]
...
vim.cmd[[autocmd FileType python inoremap <buffer> <F8> <Esc> :w \| sp \| hor resize 10 \| term uv run % <CR>]]
